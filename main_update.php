...
$query=mysqli_query($con,"UPDATE `client`(`username`,`emailid`,`password`,`retypepassword`)
VALUES('".$username."','".$emailid."','".$password."','".$retypepassword."') WHERE id='$id'");
if($query)
{
...
$query=mysqli_query($con,"select * from client where id='$id'");
...
<label for="username"><b>username</b></label>
   ...
   <!-- <label for="psw-repeat"><b>Confirmpassword</b></label>
