...
$Could_this_incident_been_avoided=$_POST['Could_this_incident_been_avoided'];
$Please_explain=$_POST['Please_explain'];
$I_certify_that_the_information_is_true=$_POST['I_certify_that_the_information_is_true'];

$sql ="INSERT INTO `info`(`I_am_reporting_a`,`Reporter_Firstname`,`Reporter_Lastname`,`Firstname`,`Lastname`,`Incident_Date`,`Incident_time`,`Location_of_incident`,`Please_describe_the_event_in_detail`,`Was_damage_done_to_the_property`,`Could_this_incident_been_avoided`,`Please_explain`,`I_certify_that_the_information_is_true`)
VALUES ('".$I_am_reporting_a."','".$Reporter_Firstname."','".$Reporter_Lastname."','".$Firstname."','".$Lastname."','".$Incident_Date."','".$Incident_time."','".$Location_of_incident."','".$Please_describe_the_event_in_detail."','".$Was_damage_done_to_the_property."','".$Could_this_incident_been_avoided."','".$Please_explain."','".$I_certify_that_the_information_is_true."')";
...
<input type="radio" name="I_am_reporting_a" value="I_am_reporting_1"> loss due to injury<br>
<input type="radio" name="I_am_reporting_a" value="I_am_reporting_b" > first aid incident<br>
<input type="radio" name="I_am_reporting_a" value="I_am_reporting_c"> Partial disablement<br>
<input type="radio" name="I_am_reporting_a" value="I_am_reporting_d"> Total disablement<br>
...
<input type="text" name="Location_of_incident" placeholder="Loccation">
...
<input type="radio" name="Was_damage_done_to_the_property" value="yes"> yes<br>
  <input type="radio" name="Was_damage_done_to_the_property" value="no"> no<br>
<h3 style="color:darkmagenta;">Could_this_incident_been_avoided</h3><br>
 <input type="radio" name="Could_this_incident_been_avoided" value="yes"> Yes<br>
  <input type="radio" name="Could_this_incident_been_avoided" value="No"> No<br>
...
<input type="submit" value="submit" name="submit" style="background-color:green;height:20px;width:60px">
</center>
</form>
</body>
</html>
